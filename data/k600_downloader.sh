...
wget $url -P $root_dl_targz
aria2c -c -j 16 -x 16 -s 16 -k 16M --max-connection-per-server=16 -d ${curr_dl} -i ${root_dl_targz}/k600_train_path.txt
...
[ ! -d $curr_dl ] && mkdir -p $curr_dl
wget $url -P $root_dl_targz
aria2c -c -j 16 -x 16 -s 16 -k 16M --max-connection-per-server=16 -d ${curr_dl} -i ${root_dl_targz}/k600_val_path.txt
...
[ ! -d $curr_dl ] && mkdir -p $curr_dl
wget $url -P $root_dl_targz
aria2c -c -j 16 -x 16 -s 16 -k 16M --max-connection-per-server=16 -d ${curr_dl} -i ${root_dl_targz}/k600_test_path.txt
